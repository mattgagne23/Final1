...
class Ui_WelcomeWindow(object):
    def setupUi(self, WelcomeWindow):
        ...
        self.stackedWidget.setGeometry(QtCore.QRect(-10, 90, 381, 351))
        ...
        self.deposit_inputEdit.setGeometry(QtCore.QRect(200, 90, 113, 20))
        ...
        self.withdrawl_amtLabel.setGeometry(QtCore.QRect(60, 180, 131, 20))
        ...
        self.withdrawal_inputEdit.setGeometry(QtCore.QRect(200, 180, 113, 20))
        ...
        self.deposit_error = QtWidgets.QLabel(parent=self.checking)
        self.deposit_error.setGeometry(QtCore.QRect(110, 110, 251, 20))
        self.deposit_error.setObjectName("deposit_error")
        self.withdrawal_error = QtWidgets.QLabel(parent=self.checking)
        self.withdrawal_error.setGeometry(QtCore.QRect(90, 200, 291, 20))
        self.withdrawal_error.setObjectName("withdrawal_error")
        ...
        self.deposit_inputEdit_2.setGeometry(QtCore.QRect(200, 90, 113, 20))
        ...
        self.checking_pageButton = QtWidgets.QPushButton(parent=self.savings)
        self.checking_pageButton.setGeometry(QtCore.QRect(50, 300, 111, 21))
        self.checking_pageButton.setStyleSheet("background-color: rgb(89, 78, 54);")
        self.checking_pageButton.setObjectName("checking_pageButton")
        self.withdrawal_inputEdit_2 = QtWidgets.QLineEdit(parent=self.savings)
        self.withdrawal_inputEdit_2.setGeometry(QtCore.QRect(200, 180, 113, 20))
        ...
        self.withdrawl_amtLabel_2.setGeometry(QtCore.QRect(60, 180, 121, 20))
        ...
        self.deposit_error_2 = QtWidgets.QLabel(parent=self.savings)
        self.deposit_error_2.setGeometry(QtCore.QRect(110, 110, 261, 20))
        self.deposit_error_2.setObjectName("deposit_error_2")
        self.withdrawal_error_2 = QtWidgets.QLabel(parent=self.savings)
        self.withdrawal_error_2.setGeometry(QtCore.QRect(110, 200, 261, 20))
        self.withdrawal_error_2.setObjectName("withdrawal_error_2")
    ...
    def retranslateUi(self, WelcomeWindow):
        ...
        self.deposit_error.setText(_translate("WelcomeWindow", "<html><head/><body><p><br/></p></body></html>"))
        self.withdrawal_error.setText(_translate("WelcomeWindow", "<html><head/><body><p><br/></p></body></html>"))
        ...
        self.checking_pageButton.setText(_translate("WelcomeWindow", "Checking Account"))
        ...
        self.deposit_error_2.setText(_translate("WelcomeWindow", "<html><head/><body><p><br/></p></body></html>"))
        self.withdrawal_error_2.setText(_translate("WelcomeWindow", "<html><head/><body><p><br/></p></body></html>"))
