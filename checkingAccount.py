# Form implementation generated from reading ui file 'checkingAccount.ui'
#
...
class Ui_checkingAccount(object):
    ...
    def retranslateUi(self, checkingAccount):
        ...
        self.balance_Label.setText(_translate("checkingAccount", "<html><head/><body><p align=\"center\"><span style=\" font-size:12pt;\">Your </span><span style=\" font-size:12pt; font-weight:600;\">checking</span><span style=\" font-size:12pt;\"> account balance is: </span></p></body></html>"))
        ...
        self.pushButton_3.setText(_translate("checkingAccount", "Checking Account Statement"))
        self.pushButton_4.setText(_translate("checkingAccount", "Savings Account"))
